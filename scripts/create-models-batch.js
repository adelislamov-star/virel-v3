...
const models = [
  ...
  {
    name: 'Raposa',
    age: 26, height: 154, weight: 54,
    dressSizeUK: '8', feetSizeUK: '6',
    breastSize: '32B', breastType: 'natural',
    eyesColour: 'Brown', hairColour: 'Redhead',
    smokingStatus: 'no', tattooStatus: 'small',
    piercingTypes: 'Nose', nationality: 'Brazilian',
    languages: ['Portuguese', 'English'],
    orientation: 'bi', workWithCouples: true, workWithWomen: false,
    rate30min: 250, rate45min: 280,
    rate1hIn: 300, rate1hOut: 350,
    rate90minIn: 450, rate90minOut: 500,
    rate2hIn: 550, rate2hOut: 600,
    rateExtraHour: 250, rateOvernight: 2300,
    blackClients: true, disabledClients: true,
    addressFlat: 'Flat 23', addressPostcode: 'HA9 8QY',
    tubeStation: 'South Kenton',
    notesInternal: 'OWO +£40, A-Level +£100, Filming with mask +£100, Bi DUO +£100, Couples +£150',
    services: ['69','fk','gfe','owo','owc','cob','a-level','dp','party-girl','lady-services','roleplay','filming-mask','foot-fetish','open-minded','light-dom','duo','bi-duo','couples','mmf','massage','sensual','striptease']
  },
  {
    name: 'Watari',
    age: 25, height: 160, weight: 50,
    dressSizeUK: '6', feetSizeUK: '4',
    breastSize: '34C', breastType: 'silicone',
    eyesColour: 'Amber', hairColour: 'Black',
    smokingStatus: 'no', tattooStatus: 'medium',
    piercingTypes: null, nationality: 'Brazilian',
    languages: ['Portuguese', 'English', 'Italian', 'Spanish'],
    orientation: 'hetero', workWithCouples: false, workWithWomen: false,
    rate30min: 250, rate45min: 280,
    rate1hIn: 300, rate1hOut: 350,
    rate90minIn: 450, rate90minOut: 500,
    rate2hIn: 550, rate2hOut: 600,
    rateExtraHour: 250, rateOvernight: 2000,
    blackClients: true, disabledClients: false,
    addressStreet: "21 Queen's Gate", addressFlat: 'Ground floor',
    addressPostcode: 'SW7 5NY', tubeStation: 'Gloucester Road',
    notesInternal: 'OWO +£50, CIF +£60. Duo with friend only.',
    services: ['69','fk','dfk','gfe','owo','owc','cob','cif','dt','fingering','party-girl','face-sitting','dirty-talk','smoking-fetish','roleplay','foot-fetish','open-minded','light-dom','spanking-giving','spanking-soft-receiving','duo','massage','prostate','b2b','erotic-massage','sensual','striptease','lapdancing','toys','handcuffs','domination','tie-and-tease']
  }
]
