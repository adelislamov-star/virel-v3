        ...
        {loading ? (
          ...
          <div className="space-y-2">
            {days.map((day) => {
              ...
              return (
                <div key={day.dateStr} className="flex items-start gap-2 py-1.5 border-b border-zinc-800/50 last:border-0">
                  <div className="w-12 flex-shrink-0 pt-0.5">
                    <div className="text-[10px] font-medium text-zinc-500 uppercase">{day.dayName}</div>
                    <div className="text-sm font-semibold text-zinc-300">{day.dayNum}</div>
                  </div>
