  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* ── TRUST BAR ── */
        .trust-bar { padding: 24px 40px; border-top: 1px solid #1A1A1A; border-bottom: 1px solid #1A1A1A; display: flex; align-items: center; justify-content: center; gap: 24px; flex-wrap: wrap; }
        .trust-bar span { font-size: 11px; letter-spacing: .18em; text-transform: uppercase; color: #808080; white-space: nowrap; }
        .trust-bar .sep { color: #333; }
        @media (max-width: 600px) {
          .trust-bar { gap: 12px; padding: 20px 24px; }
          .trust-bar span { font-size: 10px; letter-spacing: .12em; }
        }
        ...
        .f-card-price { font-size: 13px; letter-spacing: .05em; text-transform: uppercase; color: #C5A572; margin: 8px 0 0; }
        ...
        .btn-secondary { display: inline-block; border: 1px solid #333; color: #fff; padding: 16px 36px; font-size: 12px; letter-spacing: .15em; text-transform: uppercase; text-decoration: none; transition: border-color .2s, color .2s; }
